/**
 * Kinema Rendering Engine - Graphics Device Interface
 *
...
import type { GPUAdapterInfo, GPUTextureFormat } from '../../types/webgpu-types';
...
export class GraphicsDeviceFactory {
  ...
  static async create(config: GraphicsDeviceConfig): Promise<GraphicsDevice> {
    ...
    throw new Error('No supported graphics API available. WebGPU or WebGL2 is required.');
  }
...
export { RenderAPI } from '../core/types';
