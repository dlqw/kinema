/**
 * AniMaker Rendering Engine - Blur Effect
 *
...
export class BlurEffect extends PostEffect {
  ...
  apply(
    ...
    if (this.direction === 'both') {
      ...
      console.log('[BlurEffect] Applied bidirectional blur (radius:', this.radius, 'sigma:', this.sigma);
    } else {
      console.log(`[BlurEffect] Applied ${this.direction} blur (radius: ${this.radius}, sigma: ${this.sigma})`);
    }
