/**
 * AniMaker Rendering Engine - Post Processing System
 *
...
import type { GraphicsDevice, GraphicsTexture, CommandEncoder, GraphicsPipeline } from '../render/graphics/GraphicsDevice';
...
export class PostProcessingManager {
  ...
  private inputTarget: RenderTarget | null = null;
  ...
  render(inputTexture: GraphicsTexture, outputTexture?: GraphicsTexture): GraphicsTexture {
    ...
    const output = outputTexture || this.createRenderTarget(inputTexture);
    ...
    for (const effect of this.effects) {
      ...
      currentTexture = effect.apply(encoder, currentTexture, output);
   ...
   */
  renderToTarget(
    inputTexture: GraphicsTexture,
    renderTarget: RenderTarget
  ): GraphicsTexture {
    this.outputTarget = renderTarget;
   ...
   *
   * @param target - Input render target
   */
  setInputTarget(target: RenderTarget): void {
   ...
   */
  setOutputTarget(target: RenderTarget): void {
...
// Re-export types
export type { PostProcessingConfig, PostProcessingStats, RenderTarget };
