/**
 * AniMaker Rendering Engine - Render Pass
 *
...
import type { GraphicsDevice, CommandEncoder, GraphicsPipeline } from '../graphics/GraphicsDevice';
import type { RenderPassDescriptor, ColorAttachment, DepthStencilAttachment } from '../core/types';
  ...
  private createPassDescriptor(): any {
    ...
    if (this.config.depthStencilAttachment) {
      ...
      if (depthConfig.stencilClearValue !== undefined) {
        (descriptor.depthStencilAttachment as any).stencilClearValue = depthConfig.stencilClearValue;
