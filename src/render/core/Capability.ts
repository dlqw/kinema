/**
 * AniMaker Rendering Engine - GPU Capability Detection
 *
 * Detects and reports GPU capabilities for WebGPU and WebGL2.
 */

import type { RenderCapability, RenderAPI as IRenderAPI, DeviceLimits } from './types';

/**
 * Enum for render API type
 */
export enum RenderAPI {
  WebGPU = 'webgpu' as any,
  WebGL2 = 'webgl2' as any,
  None = 'none' as any,
}
...
export class CapabilityDetector {
  ...
  private static detectWebGL2(): RenderCapability | null {
    ...
    limits.maxVertexBuffers = getLimit(gl.MAX_VERTEX_ATTRIB_BINDINGS); // Approximation
