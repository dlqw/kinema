...
export function createIntroScene(): Scene {
  ...
  scene.add(
    ...(lines as RenderObject[]),
    ...(questionMarks as RenderObject[]),
    ...(painPoints as RenderObject[]),
  );
  scene.add(introText as RenderObject, butText as RenderObject, untilText as RenderObject);
  scene.add(
    logo.outerRing as RenderObject,
    logo.innerCircle as RenderObject,
    logo.playButton as RenderObject,
    logo.logoText as RenderObject,
  );
