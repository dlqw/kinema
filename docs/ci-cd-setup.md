...
This document describes the continuous integration and continuous deployment (CI/CD) pipeline for the AniMaker project.

## Overview

The AniMaker project uses GitHub Actions for CI/CD automation. The pipeline is divided into several workflows:
...
```markdown
[![CI](https://github.com/your-org/animaker/actions/workflows/ci.yml/badge.svg)](https://github.com/your-org/animaker/actions/workflows/ci.yml)
[![E2E Tests](https://github.com/your-org/animaker/actions/workflows/test.yml/badge.svg)](https://github.com/your-org/animaker/actions/workflows/test.yml)
[![codecov](https://codecov.io/gh/your-org/animaker/branch/main/graph/badge.svg)](https://codecov.io/gh/your-org/animaker)
```
