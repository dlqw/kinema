...
本节介绍 AniMaker 框架的核心类型定义。这些类型构成了整个框架的基础，理解它们对于掌握框架至关重要。
...
AniMaker 使用品牌类型（Branded Types）来防止类型混淆，提供编译时的类型安全保证。
...
**示例：**
```typescript
import { generateObjectId } from '@animaker/core';
...
**示例：**
```typescript
import { BoundingBox } from '@animaker/core';
...
**示例：**
```typescript
import { isValidAlpha } from '@animaker/core';
...
**示例：**
```typescript
import { clamp } from '@animaker/core';
...
**示例：**
```typescript
import { lerp } from '@animaker/core';
...
**示例：**
```typescript
import { lerpPoint } from '@animaker/core';
...
**示例：**
```typescript
import { isPoint3D } from '@animaker/core';
...
**示例：**
```typescript
import { isRenderObject } from '@animaker/core';
